...
async function findPersonalStory() {
    ...
    container.innerHTML = `
        <div id="fixed-prologue" class="fade-in">
            <h2 id="prologue-display-title" style="color: #ff00de;">${config.translations[lang]["prologue-title"]}</h2>
...
function copyToClipboard() {
    ...
    navigator.clipboard.writeText(pwField.value).then(() => {
        ...
        setTimeout(() => { note.innerText = originalText; note.style.color = "#ff00de"; }, 2000);
    });
}
